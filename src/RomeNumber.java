public enum RomeNumber {
    ...
    LXXXI(81),LXXXII(82),LXXXIII(83),LXXXIV(84),LXXXV(85),LXXXVI(86),LXXXVII(87),LXXXVIII(88),LXXXIX(89), XС(90),
    XCI(91),XCII(92),XCIII(93),XCIV(94),XCV(95),XCVI(96),XCVII(97),XCVIII(98),XCIX(99),C(100);

    private int arabic;

    RomeNumber(int arabic){
        this.arabic = arabic;
    }
    ...
    public static RomeNumber arabicToRome(int arabic) {
        for (RomeNumber number : values()){
            if(number.arabic==arabic){
                return number;
            }
        }
        return null;
